...
using ElmahCore.Mvc;
using ElmahCore;
using mongodot.Api.Filters;
using mongodot.BusinessServices.Installer;

namespace mongodot.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "mongodot API", Version = version + "-" + branch});
            });
